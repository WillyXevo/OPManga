...
<div class="text-center">
    ...
    <strong>
      <p class="error-desc">
        Jika yang kamu cari adalah anime one piece yang dulu ada disini,
        linknya sudah pindah <a href="http://menime.herokuapp.com" title="Menime">disini</a>.
        <br>OPManga sekarang hanya fokus ke manga One Piece :)
      </p>
    </strong>
